      ...
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            subtitle: Text(
                'Themes additional items like mini player and lyrics'.i18n),
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text(
                'Send crypto to the Saturn fund to support the development.'),
            leading: const Icon(FontAwesome5.bitcoin,
                color: Color.fromRGBO(247, 147, 26, 58), size: 36.0),
            onTap: () {
          ...
          const ListTile(
            ...
            subtitle: Text(
                'For allowing us to use his updated source & maintained forks of discontinued libs.'),
          ),
          const ListTile(
...
class _LicensesScreenState extends State<LicensesScreen> {
  static final List<List<String>> licenses = [
    [
      'Scrobblenaut',
      'NPL | DJDoubleD & Nebulino',
      'https://github.com/DJDoubleD/Scrobblenaut'
    ],
    [
      'move_to_background',
      'MIT | DJDoubleD & Coin-ai',
      'https://github.com/DJDoubleD/move_to_background'
    ],
    [
      'marquee',
      'MIT | DJDoubleD & MarcelGarus',
      'https://github.com/DJDoubleD/marquee'
    ],
    [
      'external_path',
      'MIT | DJDoubleD & Siruss187',
      'https://github.com/DJDoubleD/external_path'
    ],
    [
      'equalizer_flutter',
      'MIT | DJDoubleD & nickwph',
      'https://github.com/DJDoubleD/equalizer_flutter'
    ],
    [
      'custom_navigator',
      'MIT | DJDoubleD & justprodev',
      'https://github.com/DJDoubleD/custom_navigator'
    ],
  ];
